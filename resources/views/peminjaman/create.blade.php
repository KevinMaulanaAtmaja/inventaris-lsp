    ...
    <div class="card mt-5 d-flex">
        <form action="{{ route('peminjaman.store') }}" method="POST">
            ...
            <div class="my-3 mx-5">
                ...
                <input type="date" id="tgl_pinjam" class="form-control" name="tgl_pinjam" value="{{ old('tgl_pinjam') }}">
            </div>
            <div class="my-3 mx-5">
                <label for="tgl_kembali" class="form-label">Tgl Kembali</label>
                <input type="date" id="tgl_kembali" class="form-control" name="tgl_kembali" value="{{ old('tgl_kembali') }}">
            </div>
